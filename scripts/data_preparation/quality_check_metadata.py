...
based on GTDB CheckM estimates and prints a report.
"""
...
from config import COMPACT_METADATA_TSV
...
# ------------------------
def main():
    metadata_file = Path(COMPACT_METADATA_TSV)

    df = load_data(metadata_file, filetype="tsv")
