...
if __name__ == "__main__":
	...
	(result_df, most_genome, max_count, least_genome, min_count) = seeds_per_genome(df)

	print(result_df)
	print(f"The genome with the most seed compounds: {most_genome} (count: {max_count})")
	print(f"The genome with the least seed compounds: {least_genome} (count: {min_count})")
