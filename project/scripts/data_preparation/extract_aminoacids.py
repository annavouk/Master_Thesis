...
- Prints and saves the subset to output/common_amino_acid_compounds.tsv
"""
...
from config import COMPOUND_SUMMARY_TSV, OUTPUT_DIR
...
def get_aa(df):
    ...
    common_aa_kegg_ids = [
        "C00037", "C00041", "C00183", "C00123", "C00407", "C00049", "C00152", "C00025",
        "C00064", "C00065", "C00188", "C00073", "C00097", "C00047", "C00062", "C00135",
        "C00148", "C00079", "C00082", "C00078"
        ]

    common_aa_df = df[df['KEGG_ID'].isin(common_aa_kegg_ids)]
    
    print(f"Found {len(common_aa_df)} compounds matching common amino acids.")
    print(common_aa_df[['SEED_ID', 'compound_name', 'KEGG_ID']])
...
def main():
    ...
    # Save output
    common_aa_df.to_csv(OUTPUT_DIR/'common_amino_acid_compounds.tsv', sep='\t', index=False)
