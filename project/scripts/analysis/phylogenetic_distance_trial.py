...
- Prunes GTDB newick tree with Biopython (much safer for GTDB weird internal labels!)
"""
...
def get_target_accessions(df, subset_ids_file=None, n_top=None):
    """
...
def main():
    ...
    keep_ids = get_target_accessions(METADATA_CSV, subset_ids_file=SUBSET_IDS_FILE, n_top=N_TOP)
