...
sns.barplot(x=top_seeds.index, y=top_seeds.values, color="teal")
plt.xticks(rotation=45, ha="right")
plt.xlabel("Compound (ModelSEED ID)")
plt.ylabel("Number of Genomes (as Seed)")
...
plt.hist(seed_freq.values, bins=30, color="slateblue", edgecolor="black")
plt.xlabel("Number of Genomes (as Seed)")
